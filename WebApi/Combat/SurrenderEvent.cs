...
namespace Super_Cartes_Infinies.Combat
{
    public class SurrenderEvent : MatchEvent
    {
        ...
        public SurrenderEvent(Match match, MatchPlayerData surrenderingPlayerData, MatchPlayerData opposingPlayerData, GameConfig gameConfig)
        {
            SurrenderingPlayerId = surrenderingPlayerData.Player.Id;
            this.Events = new List<MatchEvent>()
            {
                new EndMatchEvent(match, opposingPlayerData, surrenderingPlayerData, gameConfig)
            };
        }
    }
}
