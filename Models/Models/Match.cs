...
namespace Super_Cartes_Infinies.Models
{
	public class Match : IModel
    {
        ...
        public Match(Player playerA, Player playerB, IEnumerable<Card> playerACards, IEnumerable<Card> playerBCards)
        {
            Id = 0;
            IsMatchCompleted = false;
            UserAId = playerA.UserId;
            PlayerDataA = new MatchPlayerData(playerA, playerACards);
            UserBId = playerB.UserId;
            PlayerDataB = new MatchPlayerData(playerB, playerBCards);
        }
